...
% Page dimensions
\usepackage[a4paper,inner=2.2cm,outer=2.2cm,bottom=2.2cm,headheight=2cm]{geometry} % to change the page dimensions

\setlength{\parskip}{1em} % Spacing between paragraphs
\setlength{\headsep}{5pt} % Spacing between paragraphs
