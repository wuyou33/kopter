...
%    transfer function model with numerator order nord, 
...
%    input to an optimization to determine the equivalent time 
%    delay corresponding to the minimum time / frequency domain cost.  
%
%  Input:
%    
