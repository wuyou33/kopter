function varargout = swr_gui(varargin)
%
%  SWR_GUI  M-file for swr_gui.fig.
%
%      swr_GUI, by itself, creates a new swr_GUI or raises the existing
%      singleton*.
%
%      H = swr_GUI returns the handle to a new swr_GUI or the handle to
%      the existing singleton*.
%
%      swr_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in swr_GUI.M with the given input arguments.
%
%      swr_GUI('Property','Value',...) creates a new swr_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before swr_gui_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to swr_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help swr_gui

% Last Modified by GUIDE v2.5 05-Aug-2006 23:46:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @swr_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @swr_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before swr_gui is made visible.
function swr_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to swr_gui (see VARARGIN)

% Choose default command line output for swr_gui
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes swr_gui wait for user response (see UIRESUME)
% uiwait(handles.swr_gui);
...
function varargout = swr_gui_OutputFcn(hObject, eventdata, handles)
...
% --- Executes on button press in swr_pushbutton.
function swr_pushbutton_Callback(hObject, eventdata, handles)
% hObject    handle to swr_pushbutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
