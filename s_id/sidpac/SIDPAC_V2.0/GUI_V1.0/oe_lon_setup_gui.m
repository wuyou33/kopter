function varargout = oe_lon_setup_gui(varargin)
%
%  OE_LON_SETUP_GUI  M-file for oe_lon_setup_gui.fig.
%
%      oe_lon_setup_GUI, by itself, creates a new oe_lon_setup_GUI or raises the existing
%      singleton*.
%
%      H = oe_lon_setup_GUI returns the handle to a new oe_lon_setup_GUI or the handle to
%      the existing singleton*.
%
%      oe_lon_setup_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in oe_lon_setup_GUI.M with the given input arguments.
%
%      oe_lon_setup_GUI('Property','Value',...) creates a new oe_lon_setup_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before oe_lon_setup_gui_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to oe_lon_setup_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help oe_lon_setup_gui

% Last Modified by GUIDE v2.5 10-Aug-2006 02:45:11

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @oe_lon_setup_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @oe_lon_setup_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before oe_lon_setup_gui is made visible.
function oe_lon_setup_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to oe_lon_setup_gui (see VARARGIN)

% Choose default command line output for oe_lon_setup_gui
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes oe_lon_setup_gui wait for user response (see UIRESUME)
% uiwait(handles.oe_lon_setup_gui);
...
%   set(handles.CX_text,'Visible','on');
  ...
  set(handles.Cm_text,'Visible','on');
%   set(handles.Xs_text,'Visible','off');
  set(handles.Zs_text,'Visible','off');
  set(handles.M_text,'Visible','off');
else
%   set(handles.CX_text,'Visible','off');
  set(handles.CZ_text,'Visible','off');
  set(handles.Cm_text,'Visible','off');
%   set(handles.Xs_text,'Visible','on');
  set(handles.Zs_text,'Visible','on');
  set(handles.M_text,'Visible','on');
end


% --- Outputs from this function are returned to the command line.
function varargout = oe_lon_setup_gui_OutputFcn(hObject, eventdata, handles)
...
if iflg==1
  ...
  assignin('base','dopt',dopt);
  evalin('base','coe=oe_psel(fdata,1,dopt);')
else
...
%  User code.
%
close(handles.oe_lon_setup_gui),
...
% --- Executes on button press in q_output_switch.
function q_output_switch_Callback(hObject, eventdata, handles)
% hObject    handle to q_output_switch (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of q_output_switch
...
% --- Executes on button press in ax_output_switch.
function ax_output_switch_Callback(hObject, eventdata, handles)
% hObject    handle to ax_output_switch (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of ax_output_switch


% --- Executes on button press in az_output_switch.
function az_output_switch_Callback(hObject, eventdata, handles)
% hObject    handle to az_output_switch (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of az_output_switch
