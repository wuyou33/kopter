...
%
%  Usage: oe_lat_setup_update;
%
%  Description:
%
%    Implements the run settings for lateral output-error.
%
%  Input:
%    
%    None
...
%
%    y = [beta,p,r,phi,psi,ay]
%
imo=zeros(1,6);
imo(1)=get(handles.beta_output_switch,'Value');
imo(2)=get(handles.p_output_switch,'Value');
imo(3)=get(handles.r_output_switch,'Value');
imo(4)=get(handles.phi_output_switch,'Value');
imo(5)=get(handles.ay_output_switch,'Value');
%
%
%    coe = cell structure:
