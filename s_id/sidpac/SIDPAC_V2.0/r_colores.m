...
%    parameter estimation in the time domain, both conventionally 
%    and accounting for the actual frequency content of the residuals.  
...
%      15 Jun 2002 - Replaced loops with matrix multiply, EAM.
