%
%  OFFIT_DEMO  Demonstrates orthogonal function modeling.
%
%  Usage: offit_demo;
%
%  Description:
...
fprintf('\n decouples the parameter estimation problem, because')
...
fprintf('\n\n Press any key to continue ... '),pause,
fprintf('\n\n\n Enter the value suggested or just type a carriage ')
fprintf('\n return when prompted by program offit for the number ')
