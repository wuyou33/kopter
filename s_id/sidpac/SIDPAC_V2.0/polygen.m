function [xr,xlab] = polygen(x,ip)
%
%  POLYGEN  Generates specified multivariate polynomials.  
%
%  Usage: [xr,xlab] = polygen(x,ip);
%
%  Description:
%
%    Generates a set of multivariate polynomials
%    in matrix xr, according to the 
%    indices of input vector ip, using the 
