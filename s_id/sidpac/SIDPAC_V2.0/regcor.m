...
%    the highest pair-wise correlations between regressors.  
...
%    number in x), and cor is a vector of pair-wise correlations.
%    The pair-wise correlations are ranked in descending 
%    absolute value and are output to the screen.  
%
%  Input:
%    
...
%  Output:
%
%     reg = matrix of indices for the pair-wise correlated 
%           regressors (in each row).  
%     cor = pair-wise correlation values in descending absolute
