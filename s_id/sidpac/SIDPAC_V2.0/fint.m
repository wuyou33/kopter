...
%  Input:
%    
%     h = matrix of column vector time series in the Fourier integral.
%     t = time vector.
%     w = frequency vector for the chirp z-transform, rad/sec.
%
%  Output:
%
...
%        f = frequency vector for the chirp-z transform, Hz.
%        H = complex chirp-z transform vector corresponding to h.
%
...
%  Program czts switches the sign of the exponent of Z (i.e., jay*phi).
%
Z=exp(-jay*phi);
H=czts(h,M,Z,A);
%
