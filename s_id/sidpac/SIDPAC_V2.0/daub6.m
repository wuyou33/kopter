...
%  Input:
%    
%         x = matrix of time series vectors stored columnwise.
%         n = number of rows of x to be transformed 
%             (n must be a power of 2).
%      idir = transform direction flag:
%             =  1 for the wavelet transform.
%             = -1 for the inverse wavelet transform.
%
%  Output:
%
%      wx = wavelet transform for idir=1, or
