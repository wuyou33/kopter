function [u,t,pf,f] = mksswp(amp,fmin,fmax,dt,T)
%
%  MKSSWP  Creates Schroeder sweep inputs with flat power spectra.  
%
%  Usage: [u,t,pf,f] = mksswp(amp,fmin,fmax,dt,T);
%
%  Description:
%
...
%    chirp signal u, corresponding time vector t, 
...
%
uisgn=sign(sum(cos(ph)));
%
%  Increment phase shift until a sign change occurs.
%
while sign(sum(cos(ph+phoff)))==uisgn
  phoff=phoff+dph;
end
%
