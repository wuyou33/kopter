...
%  Output:
%
%       z = matrix of column vector time series with gaussian colored noise. 
...
%
%  Use fdfilt to implement a low-pass filter 
%  with bandwidth bw.  Extended length of blnse 
%  is necessary to avoid endpoint problems.
%
