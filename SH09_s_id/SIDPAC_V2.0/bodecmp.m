function [magdb,ph,w,mag] = bodecmp(num,den,tau,lplot,w)
%
%  BODECMP  Compares Bode plots for general transfer function models. 
%
%  Usage: [magdb,ph,w,mag] = bodecmp(num,den,tau,lplot,w);
%
%  Description:
%
...
%           descending powers of s by column.
...
%  Output:
%
%    magdb = transfer function magnitude vector in dB.
%       ph = transfer function phase, deg.
%        w = frequency vector, rad/sec.
%      mag = transfer function magnitude vector.
%
%    graphics:
%      Bode plot
%
...
%      27 June 2003 - Added magnitude output, EAM.
%
