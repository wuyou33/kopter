...
%
%  Calling GUI: oe_lat_setup_gui.m
%
%  Usage: oe_lat_fill;
%
%  Description:
%
%    Fills in initial parameter values for lateral
...
%  Output:
%
%     Updated values in the lateral setup GUI for output-error.
%
...
set(handles.beta_output_switch,'Value',imo(1));
set(handles.p_output_switch,'Value',imo(2));
set(handles.r_output_switch,'Value',imo(3));
set(handles.phi_output_switch,'Value',imo(4));
set(handles.ay_output_switch,'Value',imo(5));
return
