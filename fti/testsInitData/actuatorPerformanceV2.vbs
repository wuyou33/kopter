...
workingFolder = "L:\MSH-Project Management Files\Functional Engineering\Test Division\Test_Daten\J17-03-Bench Tests\P3-J17-03-BT0214\01_Data_set-complete\02_STEPS\csv100\"

' Where the data will be saved in csv format
csvFolder = "L:\MSH-Project Management Files\Functional Engineering\Test Division\Test_Daten\J17-03-Bench Tests\P3-J17-03-BT0214\01_Data_set-complete\02_STEPS\csv100\"
...
fileNamesBigArrayFolders = Array( _
  ...
  , Array(commonAddress & "Housing SN 002\Step 1.3\2018-09-11_134524\", "3-SN002-1.3", filesNames) _
  ...
  , Array(commonAddress & "Housing SN 002\Step 2.4\2018-09-11_093806\", "8-SN002-2.4", filesNames) _ 
  , Array(commonAddress & "Housing SN 0012\Step 1.1\2018-09-06_143837\", "9-SN0012-1.1", filesNames) _
  , Array(commonAddress & "Housing SN 0012\Step 1.3\2018-09-07_142954\", "10-SN0012-1.3", filesNames) _ 
  ...
  , Array(commonAddress & "Housing SN 0012\Step 2.4\2018-09-07_131727\", "13-SN0012-2.4", filesNames) _ 
  , Array(commonAddress & "Housing SN 002\Step 3.1\2018-09-13_090851\", "14-SN002-3.1", filesNames) _
  , Array(commonAddress & "Housing SN 002\Step 3.1\2018-09-13_093445\", "15-SN002-3.1", filesNames) _
  , Array(commonAddress & "Housing SN 002\Step 3.1\2018-09-13_110629\", "16-SN002-3.1", filesNames) _
  , Array(commonAddress & "Housing SN 002\Step 3.1\2018-09-14_144214\", "17-SN002-3.1", filesNames) _
  )

' The variable iterators is used to load and operate only selected steps from above
' iterators = Array("1312")
iterators2 = Array("1-SN002-1.1","2-SN002-1.2","3-SN002-1.3","4-SN002-1.6","5-SN002-2.3.1","6-SN002-2.3.2","7-SN002-2.3.3","8-SN002-2.4"_
